...
def get_videos(channel_id):
    # Get video ID list
    # If the number of videos exceeds 500, they cannot be retrieved with videos.list
    # Note that it consumes a lot of quota
    ...
    # Get video_id from playlistsitems.list
...
def get_videoinfos(videos):
    # Receive a list of video_ids and get details
...
def get_completed_videos(channel_id):
    # Read the video list saved in GCS
...
def get_new_videos(videos, completed_videos):
    # Compare the acquired video with the video list and return the difference
